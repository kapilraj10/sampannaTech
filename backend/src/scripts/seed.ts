  ...
  const projects = [
    {
      ...
      category: 'POS System',
      client: 'Retail Corp',
      description: 'A comprehensive point-of-sale dashboard for retail stores, including billing, inventory tracking and daily sales reporting.',
      technologies: ['Next.js', 'Node.js', 'MongoDB', 'Tailwind CSS'],
      challenges: 'Managing real-time inventory across multiple locations while maintaining fast checkout speeds.',
      solution: 'Built a real-time sync system with offline-first architecture and optimistic UI updates.',
      results: '40% faster checkout, 99.9% uptime, real-time inventory visibility across all locations.',
      isDemo: true,
      isFeatured: true,
      active: true,
    },
    {
      ...
      category: 'Website',
      client: 'ServicePro',
      description: 'A modern corporate website featuring premium design, fast performance and SEO-optimized pages for lead generation.',
      technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Vercel'],
      challenges: 'Creating a visually stunning website that loads fast and ranks well on search engines.',
      solution: 'Used Next.js with static generation, optimized images, and structured data for SEO.',
      results: 'Page load under 1s, 95+ Lighthouse score, 3x increase in organic traffic.',
      isDemo: true,
      isFeatured: true,
      active: true,
    },
    {
      ...
      category: 'E-commerce',
      client: 'ShopEase',
      description: 'A full-featured e-commerce platform with product catalog, cart, checkout and order management.',
      technologies: ['Next.js', 'Node.js', 'MongoDB', 'Stripe', 'Tailwind CSS'],
      challenges: 'Building a scalable e-commerce platform that handles flash sales with thousands of concurrent users.',
      solution: 'Implemented Redis caching, CDN for assets, and a queuing system for order processing.',
      results: 'Handles 10k+ concurrent users, 99.9% payment success rate, 2s average page load.',
      isDemo: true,
      isFeatured: true,
      active: true,
    },
    {
      ...
      client: 'FoodieHub',
      description: 'A complete restaurant management solution covering order handling, menu management, table reservations and sales reporting.',
      technologies: ['React', 'Express', 'MongoDB', 'Tailwind CSS'],
      challenges: 'Streamlining kitchen operations during peak hours while managing dine-in, takeout and delivery orders.',
      solution: 'Built a real-time order routing system with kitchen display integration.',
      results: '30% faster order processing, reduced food waste by 20%, improved customer satisfaction.',
      isDemo: true,
      isFeatured: false,
      active: true,
    },
